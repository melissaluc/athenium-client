      ...
      series: [
        {
          ...
          markPoint: {
            data: [
              { coord: [22.5, 0], name: '22.5', itemStyle: { color: '#FF0000' }, symbolSize: 10, symbol:'triangle',symbolRotate: 180,symbolRotate: 180,symbolOffset: [0, -20], label: { show: true, position: 'top', offset: [0, 0] } },
